...
public class Level_20_Manage_Data_By_xml extends BaseTest {

	@Parameters({ "browser", "firstname", "lastName", "emailAdress", "password", "date", "month", "year", "companyName" })
	@BeforeClass
	public void beforeClass(String browserName, String firstName, String lastName, String emailAdress, String password, String date, String month, String year, String companyName) {
		driver = getBrowserDriver(browserName);
		homePage = PageGeneratorManager.getUserHomePage(driver);

		this.firstName = firstName;
		this.lastName = lastName;
		this.emailAdress = emailAdress + generateRandomNumber() + "@gmail.com";
